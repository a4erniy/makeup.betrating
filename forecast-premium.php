    ...
    <section class="forecast-header">
        <div class="container">
            ...
            <div class="forecast-data">
                ...
                <div class="pre-title">
                    <span class="premium"><svg><use xlink:href="/assets/image/svg-symbols.svg#crown"></use></svg> Премиум прогноз на матч</span>
                </div>
                ...
                <div class="col-8">
                    <div class="container">
                        <div class="content-box">
                            ...
                            <div class="tabs">
                                <ul>
                                    <li class="active"><a href="#">Прогноз</a></li>
                                    <li><a href="#">Турнирная таблица</a></li>
                                    <li><a href="#">Последние игры</a></li>
                                    <li><a href="#">H2H</a></li>
                                    <li><a href="#">Составы</a></li>
                                    <li><a href="#">Исходы</a></li>
                                </ul>
                            </div>
